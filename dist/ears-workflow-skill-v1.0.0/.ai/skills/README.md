...
The skills directory contains modular, reusable automation components that reduce manual overhead and prevent common mistakes in the EARS workflow.

## Skills Philosophy

Each skill follows the EARS workflow principle:
...
Skills are integrated into the EARS workflow phases:
