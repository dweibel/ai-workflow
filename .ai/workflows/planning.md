...
## Objective
Generate a comprehensive `/docs/plans/YYYY-MM-DD-feature-name.md` implementation guide. **DO NOT** write code yet.
...
Create a new file: `/docs/plans/YYYY-MM-DD-feature-name.md`

### Documentation Structure
Plans are stored in `/docs/plans/` with the full hierarchy:
- `/docs/plans/` - Implementation plans (dated: YYYY-MM-DD-feature-name.md)
- `/docs/requirements/` - Requirements and specifications (no date prefix)
- `/docs/design/` - Design documents and architecture (no date prefix)
- `/docs/tasks/` - Task lists and backlogs
- `/docs/reviews/` - Review reports (dated: YYYY-MM-DD-feature-name-review.md)
...
📄 **Full Plan**: `/docs/plans/YYYY-MM-DD-feature-name.md`
```
...
1. ✅ A comprehensive plan document exists in `/docs/plans/`
