...
This skill provides comprehensive Git worktree management for the Compound Engineering workflow, enabling isolated development environments with proper branch management.
