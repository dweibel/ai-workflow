...
The Project Reset skill implements a strategic approach to project cleanup that maintains the compound engineering benefits while preparing for new development. It uses template files to reset memory and documentation to clean states.
