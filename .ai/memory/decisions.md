...
**Current Stack**:
- **Documentation**: Markdown files in `/docs/` hierarchy
...
- Follow established directory hierarchy in `/docs/`

**Examples**:
- ✅ `/docs/plans/2025-12-16-git-worktree-integration.md`
