...
- `/docs/requirements/` - Detailed requirements referenced by plans
- `/docs/design/` - Design documents that inform planning
- `/docs/tasks/` - Task breakdowns extracted from plans
