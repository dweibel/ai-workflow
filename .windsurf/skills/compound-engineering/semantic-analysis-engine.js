    ...
    initializeTriggerPatterns() {
        return {
            ...
            exact: {
                ...
                'git-worktree': { skill: 'git-worktree', confidence: 100 },
            ...
            primary: {
                ...
                'implement feature': { skill: 'git-worktree', confidence: 90 },
                'review code': { skill: 'testing-framework', confidence: 92 },
                'security audit': { skill: 'testing-framework', confidence: 94 },
                'git worktree': { skill: 'git-worktree', confidence: 88 },
                'isolated environment': { skill: 'git-worktree', confidence: 85 }
            },
            ...
            semantic: {
                ...
                'time to implement': { skill: 'git-worktree', confidence: 74 },
                'build feature': { skill: 'git-worktree', confidence: 82 },
                'fix bug': { skill: 'git-worktree', confidence: 80 }
            },

            // Tier 4: Contextual Inference (50-69%)
            contextual: {
                'authentication not working': { skill: 'git-worktree', confidence: 65, context: 'error' },
